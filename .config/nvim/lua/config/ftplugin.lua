...
local settings = {
  ...
  go = { go_indent = true, treesitter = true },
  gomod = { indent = 4, treesitter = true },
  gosum = { indent = 4, treesitter = true },
  gowork = { indent = 4, treesitter = true },
  ...
  sql = { indent = 2, treesitter = true },
  svelte = { indent = 2, treesitter = true },
  ...
  zsh = { indent = 2 },
  astro = { indent = 2, treesitter = true },
}
